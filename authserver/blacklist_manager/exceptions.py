...
# class BlacklistedRefreshToken(BlacklistManagerError):
#     """
#     This exception will be raised when we try to update the associated access token of a blacklisted token
#     """
#     pass
